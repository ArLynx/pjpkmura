...
<div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-slate-500">
            Kelola akun, peran, instansi, dan status akses.
        </p>
    </div>
...
<div class="mb-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
    ...
    <form method="GET" class="grid gap-3 md:grid-cols-4">
        ...
        <input
            ...
            class="rounded-xl border-slate-300 focus:border-sky-600 focus:ring-sky-600 md:col-span-2"
        >
        ...
        <div class="flex gap-2">
            ...
            <button
                class="rounded-xl bg-slate-800 px-4 text-white hover:bg-slate-900"
                ...
                @forelse($users as $user)
                    ...
                    <tr class="hover:bg-sky-50">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <span class="inline-flex rounded-full bg-[#D8F3FC] px-3 py-1 text-xs font-semibold capitalize text-[#0879AE]">
