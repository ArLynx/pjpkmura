    ...
    <div class="mb-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <p class="mt-3 text-slate-500">
            ...
            @if ($role == 'superadmin')
                ...
                Melalui dashboard ini Anda dapat mengelola data admin, pilar,
                indikator, target, realisasi, berita, publikasi,
                serta memonitor perkembangan pengisian data oleh setiap instansi.

            @else

                Melalui dashboard ini Anda dapat mengelola target,
                realisasi, data pendukung, serta memonitor perkembangan
