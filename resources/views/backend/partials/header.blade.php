    ...
    <div class="flex h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <button id="sidebarToggle"
                type="button"
                class="rounded-xl p-2 text-slate-600 hover:bg-[#E0F4FC] hover:text-[#0879AE] lg:hidden">
        ...
        <div class="flex items-center">
            ...
            <a href="{{ route('admin.profile.edit') }}"
                class="flex items-center gap-3 rounded-xl px-2 py-2 hover:bg-[#E0F4FC]">
                ...
                {{-- Icon profile --}}
                <div class="flex h-11 w-11 items-center justify-center rounded-full bg-[#0B91CF] text-white shadow-sm">
