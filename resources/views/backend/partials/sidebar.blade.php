...
<aside id="adminSidebar"
    class="fixed inset-y-0 left-0 z-40 flex w-64 -translate-x-full flex-col border-r border-teal-100 bg-teal-50 transition-transform duration-200 lg:translate-x-0">
