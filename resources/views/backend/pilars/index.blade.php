...
<div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-slate-500">
            Urutan pilar menentukan susunan pada dashboard publik.
        </p>
    </div>

    <a href="{{ route('admin.pilars.create') }}"
...
<div class="mb-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
    ...
    <form method="GET" class="flex gap-2">
        ...
        <button
            class="rounded-xl bg-slate-800 px-5 text-white hover:bg-slate-900"
        >
            Cari
        </button>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                @forelse($pilars as $pilar)
                    ...
                    <tr class="hover:bg-sky-50">
                        ...
                        {{-- Urutan --}}
                        <td class="px-6 py-4 font-bold text-[#0B91CF]">
                            {{ $pilar->urutan }}
                        </td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="flex justify-end gap-2">
                                ...
                                <a
                                    href="{{ route('admin.pilars.edit', $pilar) }}"
                                ...
                                <form
                                    method="POST"
                                    action="{{ route('admin.pilars.destroy', $pilar) }}"
                                    onsubmit="return confirm('Menghapus pilar akan menghapus indikator, target, realisasi, dan data pendukung terkait. Lanjutkan?')"
                                >
