    ...
    <section class="border-b border-slate-200 bg-white">
        ...
        <div class="mx-auto max-w-7xl px-6 py-10">
            ...
            <p class="mt-3 max-w-3xl text-sm leading-relaxed text-slate-500">
                ...
                untuk transparansi data yang akurat.
            </p>
        ...
        <div class="mb-8 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            >
                ...
                <div class="flex flex-col gap-3 md:flex-row">
                    ...
                    <button
                        type="submit"
                        class="inline-flex items-center justify-center gap-2 rounded-xl bg-teal-700 px-6 py-3 text-sm font-semibold text-white transition hover:bg-teal-800"
                    >
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                @foreach($publikasis as $publikasi)
                    ...
                    >
                        ...
                        <div
                            class="flex h-64 w-full items-center justify-center overflow-hidden bg-slate-50"
                        >

                            @if($publikasi->cover)

                                <img
                                    src="{{ asset('storage/' . $publikasi->cover) }}"
                                    alt="{{ $publikasi->judul }}"
                        ...
                        <div class="p-5">
                            ...
                            <h2
                                class="line-clamp-2 min-h-[48px] text-base font-bold leading-snug text-slate-800"
                            >
                            ...
                            >
                                ...
                                @if($publikasi->file)
                                    ...
                                    <a
                                        href="{{ asset('storage/' . $publikasi->file) }}"
                                        target="_blank"
                                        download
